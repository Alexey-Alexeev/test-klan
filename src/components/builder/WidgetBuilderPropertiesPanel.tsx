...
import { updateWidget, deleteWidget, duplicateWidget, bringToFront, sendToBack } from '../../features/widgetBuilder/widgetBuilderSlice';
import { 
  IWidget, 
  IButtonWidget, 
  ITextWidget, 
...
export function WidgetBuilderPropertiesPanel() {
  ...
  const { selectedWidgetId, widgets } = useAppSelector(state => state.widgetBuilder);
