...
import { setCanvasSize, toggleCanvasSizeLock, setSelectedPreset } from '../../features/widgetBuilder/widgetBuilderSlice';

interface WidgetBuilderCanvasToolbarProps {
  sizeDraft: { width: string; height: string };
  onSizeDraftChange: (draft: { width: string; height: string }) => void;
  onCommitSize: () => void;
}

export function WidgetBuilderCanvasToolbar({ sizeDraft, onSizeDraftChange, onCommitSize }: WidgetBuilderCanvasToolbarProps) {
