...
export function WidgetBuilderTab() {
  ...
  const { widgets, canvasSize, selectedPreset } = useAppSelector(state => state.widgetBuilder);
    ...
    <div className="flex-1 flex flex-col h-full">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div ref={mainAreaRef} className="flex-1 flex flex-col">
          {viewMode === 'design' ? (
            <BuilderCanvas viewportContainerRef={mainAreaRef} />
          ) : (
        ...
        {/* Properties panel */}
        {viewMode === 'design' && <WidgetBuilderPropertiesPanel />}
      </div>
    </div>
  );
}
